...
export default function BlogDetail() {
  ...
  return (
        <article className="bg-white rounded-xl shadow-lg p-8 max-w-4xl mx-auto my-12">
          <Link
            to="/"
            className="inline-flex items-center gap-1 text-sm text-gray-600 hover:text-gray-800 mb-6 bg-gray-100 hover:bg-gray-200 px-2 py-1 rounded-lg"
          >
            ← กลับหน้าหลัก
          </Link>
